...
See DEPLOYMENT.md for the full production deployment guide and ENVIRONMENTS.md for environment configuration details.
...
See ARCHITECTURE.md for a full breakdown of the system design, including the frontend/backend data flow and infrastructure layer.

📞 Contact

IGK Learning Centre Mae Sot, Thailand
